...
public class DocumentMyApplication extends Application
    ...
    public void onCreate() {
        ...
        boolean isDark = docreader.aidoc.pdfreader.PreferenceUtils.getInstance(this).getBoolean(docreader.aidoc.pdfreader.AppGlobalConstants.PREF_NIGHT_MODE, false);
        if (isDark) {
