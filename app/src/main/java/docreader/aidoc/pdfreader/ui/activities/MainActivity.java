...
import docreader.aidoc.pdfreader.BuildConfig;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void initializeData() {
        docreader.aidoc.pdfreader.viewmodel.DataSingletonRecent.getInstance().refresh(this);
        docreader.aidoc.pdfreader.viewmodel.DataSingletonFavorite.getInstance().refresh(this);
    }
