...
public class ViewOfficeActivity extends AppNUIActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (prefUtils.getBoolean(AppGlobalConstants.ACTION_RATE_APP, true)) {
                if (savedInstanceState == null) {
                    int openCount = prefUtils.getInt(AppGlobalConstants.KEY_DOCUMENT_OPEN_COUNT, 0) + 1;
                    prefUtils.setInt(AppGlobalConstants.KEY_DOCUMENT_OPEN_COUNT, openCount);
                    if (openCount == 4) {
            ...
            if (currentIntent.getData() != null && currentIntent.getData().getPath() != null
                ...
                selectedFilePath = currentIntent.getStringExtra(AppGlobalConstants.EXTRA_SELECTED_FILE_URI);
