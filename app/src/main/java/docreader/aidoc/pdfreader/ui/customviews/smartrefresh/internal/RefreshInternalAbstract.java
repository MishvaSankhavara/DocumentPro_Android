...
public abstract class RefreshInternalAbstract extends RelativeLayout implements RefreshComponent {
    ...
    public RefreshSpinnerStyle getSpinnerBehavior() {
        ...
        if (wrappedView != null) {
            ...
            if (params instanceof docreader.aidoc.pdfreader.ui.customviews.smartrefresh.SmartRefreshLayout.LayoutParams) {
                spinnerStyle = ((docreader.aidoc.pdfreader.ui.customviews.smartrefresh.SmartRefreshLayout.LayoutParams) params).spinnerStyle;
                if (spinnerStyle != null) {
                    return spinnerStyle;
                }
            }
    ...
    public void onComponentInitialized(@NonNull RefreshManager kernel, int height, int maxDragHeight) {
        if (wrappedInternal != null && wrappedInternal != this) {
            ...
            ViewGroup.LayoutParams params = wrappedView.getLayoutParams();
            if (params instanceof docreader.aidoc.pdfreader.ui.customviews.smartrefresh.SmartRefreshLayout.LayoutParams) {
                kernel.requestDrawBackground(this, ((docreader.aidoc.pdfreader.ui.customviews.smartrefresh.SmartRefreshLayout.LayoutParams) params).backgroundColor);
            }
        }
    }
