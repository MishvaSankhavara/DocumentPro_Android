package com.arkay.gkinhindi.adapter_reader;
...
import com.arkay.gkinhindi.database.OnDataUpdatedEvent;
import com.arkay.gkinhindi.database.DatabaseHelper;
import com.arkay.gkinhindi.clickListener.MoreClickListener;
...
public class CompactFileListAdapter extends RecyclerView.Adapter<CompactFileListAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder,
                        int position) {
                PDFReaderModel pdfModel = originalData_FileListAdapter2.get(position);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
                ...
                public ViewHolder(@NonNull View itemView) {
                        ...
                        ivLock_FileListAdapter2 = itemView.findViewById(R.id.iv_lock);

                        lock_line_FileListAdapter2 = itemView.findViewById(R.id.lock_line);

                        tvName_FileListAdapter2 = itemView.findViewById(R.id.tv_name);

                        tvDate_FileListAdapter2 = itemView.findViewById(R.id.tvFileDate);

                        tvFileSize_FileListAdapter2 = itemView.findViewById(R.id.tvFileSize);

                        imgMore_FileListAdapter2 = itemView.findViewById(R.id.item_pdf_more);

                        btnFavorite_FileListAdapter2 = itemView.findViewById(R.id.img_favorite);
                }
                ...
                public void bindPdf_FileListAdapter2(PDFReaderModel pdfModel) {
                        ...
                        if (pdfModel.isProtected_PDFModel()) {
                                if (lock_line_FileListAdapter2 != null)
                                        lock_line_FileListAdapter2.setVisibility(View.VISIBLE);
                                if (ivLock_FileListAdapter2 != null)
                        ...
                        btnFavorite_FileListAdapter2.setOnClickListener(v -> {
                                ...
                                if (databaseHelper_FileListAdapter2.isStared_DatabaseHelper(
                                        ...
                                        databaseHelper_FileListAdapter2
                                                        .addStaredDocument_DatabaseHelper(
                                                                        pdfModel.getFileUri_PDFModel());
                        ...
                        imgMore_FileListAdapter2.setOnClickListener(v -> Utils.showMoreDialog(
                                        mContext_FileListAdapter2,
                                        document,
                                        false,
                                        new MoreClickListener() {
                                                ...
                                                public void onRenameListener(String newName) {
                                                        ...
                                                        final File fileOldPdfName = new File(
                                                                        pdfModel.getFileUri_PDFModel());

                                                        final String replaceName = pdfModel.getFileUri_PDFModel()
                                                                        .replace(
                                                        ...
                                                        if (fileOldPdfName.renameTo(
                                                                ...
                                                                if (databaseHelper_FileListAdapter2
                                                                                .isStared_DatabaseHelper(
                                                                ...
                                                                documentNew.setFileUri_PDFModel(
                                                                                newFile.getAbsolutePath());
                                                                documentNew.setLength_PDFModel(newFile.length());
                                                                documentNew.setLastModified_PDFModel(
                                                                                newFile.lastModified());

                                                                int position = getAdapterPosition();

                                                                if (position != RecyclerView.NO_POSITION
                                                                                && position < originalData_FileListAdapter2
                                                                                                .size()) {

                                                                        originalData_FileListAdapter2.set(position,
                                                                                        documentNew);
                                                ...
                                                public void onDeleteListener() {
                                                        ...
                                                        File fileToDelete = new File(pdfModel.getFileUri_PDFModel());
