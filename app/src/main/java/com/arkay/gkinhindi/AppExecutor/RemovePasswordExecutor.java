...
public class RemovePasswordExecutor {
    ...
    public void executeTask_removePW() {
        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskStart("UNLOCK_PDF");
            ...
            try {
                ...
                weakReference_removePW.get().runOnUiThread(() -> {
                    ...
                    weakReference_removePW.get().showCompletionUI(() -> {
                        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskSuccess("UNLOCK_PDF", pdfModelNew.getName_PDFModel());
                ...
                com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskFailure("UNLOCK_PDF", e.getMessage(), e);
            }
        });
    }
