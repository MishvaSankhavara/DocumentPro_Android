...
import com.arkay.gkinhindi.utils.ImageProcessorUtils;
...
public class FileCompressionExecutor {
    ...
    public void executeTask_FileCompression() {
        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskStart("COMPRESS");
        executor_FileCompression.execute(() -> {
            ...
            allPdfDocumentDir_FileCompression = Constants.DIRECTORY_COMPRESSED_PDF;
            ...
            try {
                    ...
                    if (weakReference_FileCompression.get() != null) {
                        weakReference_FileCompression.get().runOnUiThread(() -> {
                            ...
                            weakReference_FileCompression.get().showCompletionUI(() -> {
                                ...
                                com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskSuccess("COMPRESS", file1.getName());
                ...
                Log.e(Constants.DOC_APP_FATAL, "Error message", e);
                com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskFailure("COMPRESS", e.getMessage(), e);
            }
        });
    }
