...
public class PdfMergeManager {
    ...
    public void executeTask_PdfMergeManager() {
        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskStart("MERGE");
        executor_PdfMergeManager.execute(() -> {
            ...
            weakReference_PdfMergeManager.get().runOnUiThread(() -> {
                ...
                for (int i = 0; i < pdfPaths_PdfMergeManager.size(); i++) {
                    try {
                        ...
                        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskFailure("MERGE", e.getMessage(), e);
            ...
            weakReference_PdfMergeManager.get().runOnUiThread(() -> {
                ...
                weakReference_PdfMergeManager.get().showCompletionUI(() -> {
                    ...
                    com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskSuccess("MERGE", file1_PdfMergeManager.getName());
