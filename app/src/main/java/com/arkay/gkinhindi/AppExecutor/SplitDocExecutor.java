...
public class SplitDocExecutor {
    ...
    public void executeTask_SplitDoc() {
        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskStart("SPLIT");
        executor_SplitDoc.execute(() -> {
            ...
            try {
                ...
                String splitPdfDocumentDir_SplitDoc = Constants.DIRECTORY_SPLIT_PDF;
                ...
                weakReference_SplitDoc.get().runOnUiThread(() -> {
                    ...
                    weakReference_SplitDoc.get().showCompletionUI(() -> {
                        ...
                        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskSuccess("SPLIT", file_SplitDoc.getName());
                ...
                com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskFailure("SPLIT", error_SplitDoc.getMessage(), error_SplitDoc);
            }
        });
    }
