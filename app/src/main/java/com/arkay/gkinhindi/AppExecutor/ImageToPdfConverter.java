...
public class ImageToPdfConverter {
    ...
    public void executeTask_ImageToPdfConverter() {
        com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskStart("PHOTO_TO_PDF");
        executor_ImageToPdfConverter.execute(() -> {
            try {
                String allPdfDocuments = Constants.DIRECTORY_IMAGE_TO_PDF;
                ...
                e.printStackTrace();
                com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskFailure("PHOTO_TO_PDF", e.getMessage(), e);
            }
            ...
            weakReference_ImageToPdfConverter.get().runOnUiThread(() -> {
                ...
                weakReference_ImageToPdfConverter.get().showCompletionUI(() -> {
                    ...
                    com.arkay.gkinhindi.utils.AnalyticsHelper.logTaskSuccess("PHOTO_TO_PDF", file.getName());
