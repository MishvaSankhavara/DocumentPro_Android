package com.arkay.gkinhindi.viewmodel;
...
public class DataSingletonFavorite {
    ...
    public void refresh(android.content.Context context) {
        ...
        favoriteDocuments.addAll(com.arkay.gkinhindi.database.DatabaseHelper.getInstance(context).getStarredDocuments_DatabaseHelper());
        favoriteDocumentsLiveData.setValue(favoriteDocuments);
    }
}
