...
public class MoreDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (idView == R.id.ll_rename) {
            ...
            DialogManagerUtils.showConfirmationDialog(activity, Constants.DIALOG_CONFIRM_REMOVE_RECENT, new OnConfirmClickListener() {
                @Override
            ...
            DialogManagerUtils.showConfirmationDialog(activity, Constants.DIALOG_CONFIRM_DELETE, new OnConfirmClickListener() {
                @Override
                public void onConfirmClickListener() {
                    if (optionsListener != null) {
