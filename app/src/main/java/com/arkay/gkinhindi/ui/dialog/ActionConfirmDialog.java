...
public class ActionConfirmDialog extends Dialog {
    ...
    private void setupDialogContent() {
        if (dialogType == Constants.DIALOG_CONFIRM_DELETE) {
        ...
        } else if (dialogType == Constants.DIALOG_CONFIRM_REMOVE_RECENT) {
        ...
        } else if (dialogType == Constants.DIALOG_CONFIRM_REMOVE_FAVORITE) {
            tvTitle.setText(R.string.dialog_favorite_remove);
            tvMessage.setText(R.string.dialog_remove_message);
            btnCancel.setText(R.string.action_cancel);
            btnConfirm.setText(R.string.action_yes);

        }else if (dialogType == Constants.DIALOG_CONFIRM_EXIT_MERGE) {
        ...
        }else if (dialogType == Constants.DIALOG_CONFIRM_EXIT_SPLIT) {
            tvTitle.setText(R.string.dialog_split_exit_title);
            tvMessage.setText(R.string.dialog_merge_exit_message);
            btnCancel.setText(R.string.action_cancel);
            btnConfirm.setText(R.string.action_quit);
        }else if (dialogType == Constants.DIALOG_CONFIRM_EXIT_PHOTO_TO_PDF) {
            tvTitle.setText(R.string.dialog_convert_exit_title);
            tvMessage.setText(R.string.dialog_merge_exit_message);
            btnCancel.setText(R.string.action_cancel);
            btnConfirm.setText(R.string.action_quit);
        }else if (dialogType == Constants.DIALOG_CONFIRM_CLEAR_RECENT) {
        ...
        } else if (dialogType == Constants.DIALOG_CONFIRM_CLEAR_FAV) {
            tvTitle.setText(R.string.dialog_clear_confirm_title);
