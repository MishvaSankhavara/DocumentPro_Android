...
import com.arkay.gkinhindi.clickListener.OnThumbnailClickListener;
...
public class SplitChooseFileActivity extends AppCompatActivity implements OnThumbnailClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            selectedPdfModel = (PDFReaderModel) intent.getSerializableExtra(Constants.EXTRA_PDF_MODEL);
    ...
    private void setupToolbar() {
        ...
        tvToolbarName.setText(
                getString(R.string.label_items_selected,
                        String.valueOf(MyApplication.getInstance().getArrayListSplit().size())));
    ...
    public void onBackPressed() {
        ...
        Utils.showConfirmDialog(this, Constants.DIALOG_CONFIRM_EXIT_SPLIT, new OnConfirmClickListener() {
            @Override
