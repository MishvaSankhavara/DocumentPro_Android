...
import static com.arkay.gkinhindi.Constants.EXTRA_FILE_TYPE;
...
public class DocumentListActivity extends ActivityBase implements DocClickListener, SortingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            fileType = getIntent().getIntExtra(EXTRA_FILE_TYPE, Constants.FILE_TYPE_ALL);
        }
        initializeViews();
    ...
    private void applyToolbarTheme(int fileType) {
        ...
        selectedFileType = Constants.QUERY_ALL_DOCUMENT_FILES;
        if (fileType == Constants.FILE_TYPE_EXCEL) {
            colorCode = R.color.app_excel_list_bg;
            title = R.string.title_toolbar_excel;
            selectedFileType = Constants.QUERY_EXCEL_FILES;
        } else if (fileType == Constants.FILE_TYPE_PDF) {
            colorCode = R.color.app_pdf_list_bg;
            selectedFileType = Constants.QUERY_PDF_FILES;
            title = R.string.tittle_toolbar_pdf;
        } else if (fileType == Constants.FILE_TYPE_PPT) {
            colorCode = R.color.app_ppt_list_bg;
            title = R.string.title_toolbar_powerpoint;
            selectedFileType = Constants.QUERY_PPT_FILES;
        } else if (fileType == Constants.FILE_TYPE_WORD) {
            colorCode = R.color.app_word_list_bg;
            title = R.string.tittle_toolbar_word;
            selectedFileType = Constants.QUERY_WORD_FILES;
        } else if (fileType == Constants.FILE_TYPE_TEXT) {
            colorCode = R.color.app_txt_list_bg;
            title = R.string.tittle_toolbar_txt;
            selectedFileType = Constants.QUERY_TEXT_FILES;
        }
