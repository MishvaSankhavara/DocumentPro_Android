...
import com.arkay.gkinhindi.database.DatabaseHelper;
import com.arkay.gkinhindi.AppExecutor.FavoriteRemovalExecutor;
import com.arkay.gkinhindi.clickListener.OnItemSelectListener;
...
public class SelectDocumentActivity extends ActivityBase implements View.OnClickListener, OnItemSelectListener {
    ...
    private void readIntentData() {
        ...
        if (intent != null) {
            selectedFileType = getIntent().getIntExtra(Constants.EXTRA_FILE_TYPE,
                    Constants.FILE_TYPE_ALL);
        }
    ...
    private void initViews() {
        ...
        if (selectedFileType == Constants.FILE_TYPE_ALL) {
            ...
            documentList = Utils.countFile(this, Constants.QUERY_ALL_DOCUMENT_FILES);
        } else if (selectedFileType == Constants.FILE_TYPE_EXCEL) {
            ...
            moveButtonLayout.setVisibility(View.GONE);
            documentList = Utils.countFile(this, Constants.QUERY_EXCEL_FILES);
        } else if (selectedFileType == Constants.FILE_TYPE_PDF) {
            ...
            moveButtonLayout.setVisibility(View.GONE);
            documentList = Utils.countFile(this, Constants.QUERY_PDF_FILES);
        } else if (selectedFileType == Constants.FILE_TYPE_PPT) {
            ...
            moveButtonLayout.setVisibility(View.GONE);
            documentList = Utils.countFile(this, Constants.QUERY_PPT_FILES);
        } else if (selectedFileType == Constants.FILE_TYPE_WORD) {
            ...
            moveButtonLayout.setVisibility(View.GONE);
            documentList = Utils.countFile(this, Constants.QUERY_WORD_FILES);

        } else if (selectedFileType == Constants.FILE_TYPE_FAVORITE) {
            mainContainerLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.app_all_list_bg));
        ...
        } else if (selectedFileType == Constants.FILE_TYPE_RECENT) {
            mainContainerLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.app_all_list_bg));
    ...
    public void onClick(View v) {
        ...
        if (idView == R.id.ll_share) {
            ...
            if (selectedFileType == Constants.FILE_TYPE_RECENT) {
                DialogManagerUtils.showConfirmationDialog(SelectDocumentActivity.this,
                        Constants.DIALOG_CONFIRM_REMOVE_RECENT, new OnConfirmClickListener() {
                            @Override
                ...
                DialogManagerUtils.showConfirmationDialog(SelectDocumentActivity.this,
                        Constants.DIALOG_CONFIRM_REMOVE_FAVORITE, new OnConfirmClickListener() {
                            @Override
                            public void onConfirmClickListener() {
            ...
            DialogManagerUtils.showConfirmationDialog(SelectDocumentActivity.this,
                    Constants.DIALOG_CONFIRM_DELETE, new OnConfirmClickListener() {
                        @Override
                        public void onConfirmClickListener() {
    ...
    public static class DeleteMultiFile extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (weakReference.get().selectedFileType == Constants.FILE_TYPE_ALL) {

                weakReference.get().documentList = Utils.countFile(weakReference.get(),
                        Constants.QUERY_ALL_DOCUMENT_FILES);
            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_EXCEL) {
                weakReference.get().documentList = Utils.countFile(weakReference.get(),
                        Constants.QUERY_EXCEL_FILES);
            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_PDF) {

                weakReference.get().documentList = Utils.countFile(weakReference.get(),
                        Constants.QUERY_PDF_FILES);
            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_PPT) {

                weakReference.get().documentList = Utils.countFile(weakReference.get(),
                        Constants.QUERY_PPT_FILES);
            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_WORD) {

                weakReference.get().documentList = Utils.countFile(weakReference.get(),
                        Constants.QUERY_WORD_FILES);

            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_FAVORITE) {
                weakReference.get().documentList = DatabaseHelper.getInstance(weakReference.get())
                        .getStarredDocuments_DatabaseHelper();

            } else if (weakReference.get().selectedFileType == Constants.FILE_TYPE_RECENT) {
                weakReference.get().documentList = DatabaseHelper.getInstance(weakReference.get())
