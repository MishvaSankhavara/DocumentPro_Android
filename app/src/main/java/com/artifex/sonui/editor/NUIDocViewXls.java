        ...
        var2.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> var1, View var2x, int var3x, long var4) {
                ...
                label11:
                {
                    ...
                    if (var6 != null) { // Kiểm tra xem var6 có null không
                        ...
                        // Xử lý khi var6 là null
                        return; // hoặc thực hiện hành động phù hợp ở đây
                    }
                }
...
//            this.onClickFunctionButton(var1);
    ...
    public void preSave() {
        if ((DocExcelView) this.getDocView() != null) {
...
//        }
        DocView var1 = this.getDocView();
        if (var1 != null) {
            if (var1 instanceof DocExcelView) {
                if (((DocExcelView) var1).copyEditTextToCell()) {
                    SODocSession var2 = this.getSession();
                    if (var2 != null) {
                        SOFileState var3 = var2.getFileState();
                        if (var3 != null) {
