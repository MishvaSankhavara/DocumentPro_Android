...
public class LanguageSelectionActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_apply_locale).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PreferenceUtils utils = PreferenceUtils.getInstance(LanguageSelectionActivity.this);
                ...
                Intent restartIntent = new Intent(LanguageSelectionActivity.this, nextActivity);
