...
public class CompressFragment extends Fragment implements OnPdfClickListener {
    ...
    public CompressFragment(ResultViewerActivity mActivity) {
    ...
    public static class LoadFile extends AsyncTask<Void, Void, Void> {
        WeakReference<CompressFragment> weakReference;

        public LoadFile(CompressFragment compressFragment) {
            this.weakReference = new WeakReference<>(compressFragment);
        }

        @Override
        protected Void doInBackground(Void... voids) {
            this.weakReference.get().arrayList = Utils.getCreatedPdf(GlobalConstant.RootDirectoryCompressSaved);
            return null;
        }
