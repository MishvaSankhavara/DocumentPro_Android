...
public class PdfFragment extends Fragment implements DocumentClickListener {
    ...
    public PdfFragment(Activity mActivity) {
    ...
    private void listFile() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                arrayList = Utils.countFile(mActivity, GlobalConstant.COUNT_PDF_FILE);

                mActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter = new FileListAdapter(mActivity, arrayList, PdfFragment.this);
