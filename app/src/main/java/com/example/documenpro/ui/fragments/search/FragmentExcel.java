...
public class FragmentExcel extends Fragment implements DocClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        searchViewModel.getQuery().observe(requireActivity(), s -> Utils.searchDocument(s, arrayList, excelAdapter));
    }
    ...
    private void listFile() {
        ...
        backgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                arrayList = Utils.countFile(activityContext, GlobalConstant.COUNT_EXCEL_FILE);
