...
public class PptFragment extends Fragment implements DocumentClickListener {
    ...
    public PptFragment(Activity mActivity) {
    ...
    private void listFile() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                arrayList = Utils.countFile(mActivity, GlobalConstant.COUNT_PPT_FILE);

                mActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter = new ListFileAdapter(mActivity, arrayList, PptFragment.this);
