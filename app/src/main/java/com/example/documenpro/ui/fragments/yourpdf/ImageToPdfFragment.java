...
public class ImageToPdfFragment extends Fragment implements OnPdfClickListener {
    ...
    public ImageToPdfFragment(ResultViewerActivity mActivity) {
    ...
    private static class LoadFile extends AsyncTask<Void, Void, Void> {
        WeakReference<ImageToPdfFragment> weakReference;
