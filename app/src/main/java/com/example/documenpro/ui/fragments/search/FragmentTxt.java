...
public class FragmentTxt extends Fragment implements DocClickListener {
    ...
    private void listFile() {
        ...
        backgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                arrayList = Utils.countFile(activityContext, GlobalConstant.COUNT_TXT_FILE);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        searchViewModel.getQuery().observe(requireActivity(), s -> Utils.searchDocument(s, arrayList, txtAdapter));
    }
    @Override
