...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    public FavoriteAdapter(Activity mContext, DocumentClickListener listener) {
        this.mContext = mContext;
        this.listener = listener;
        this.arrayList = DbHelper.getInstance(mContext).getStarredDocuments();
                    ...
                    public void onRename(String newName) {
                        ...
                        if (fileOldPdfName.renameTo(new File(replaceName))) {
                            if (dbHelper.isRecent(fileOldPdfName.getAbsolutePath())) {
                                ...
                                RecentDataSingleton.getInstance().addRecentDocument(document);
                            }
